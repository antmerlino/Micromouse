...
override PKGDIR = xconfig_micromouse
...
C:/ti/xdctools_3_25_04_88/packages/ti/targets/arm/elf/IArm.xs:
package.mak: C:/ti/xdctools_3_25_04_88/packages/ti/targets/arm/elf/IArm.xs
C:/ti/xdctools_3_25_04_88/packages/ti/targets/arm/elf/package.xs:
package.mak: C:/ti/xdctools_3_25_04_88/packages/ti/targets/arm/elf/package.xs
...
package/%.xdc.inc package/%_xconfig_micromouse.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_micromouse" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: micromouse.pem4f

-include package/cfg/micromouse_pem4f.mak
-include package/cfg/micromouse_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/micromouse_pem4f.dep
endif
micromouse.pem4f: package/cfg/micromouse_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
micromouse.pem4f package/cfg/micromouse_pem4f.c: .libraries,em4f
endif

package/cfg/micromouse_pem4f.c package/cfg/micromouse_pem4f.h package/cfg/micromouse_pem4f.xdl: override _PROG_NAME := micromouse.xem4f
package/cfg/micromouse_pem4f.c: package/cfg/micromouse_pem4f.cfg

clean:: clean,em4f
	-$(RM) package/cfg/micromouse_pem4f.cfg
	-$(RM) package/cfg/micromouse_pem4f.dep
	-$(RM) package/cfg/micromouse_pem4f.c
	-$(RM) package/cfg/micromouse_pem4f.xdc.inc

clean,em4f::
	-$(RM) micromouse.pem4f
.executables,em4f .executables: micromouse.xem4f

micromouse.xem4f: |micromouse.pem4f

-include package/cfg/micromouse.xem4f.mak
micromouse.xem4f: package/cfg/micromouse_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/micromouse_pem4f.oem4f   package/cfg/micromouse_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
micromouse.xem4f: export C_DIR=
micromouse.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
micromouse.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

micromouse.test test,em4f test: micromouse.xem4f.test

micromouse.xem4f.test:: micromouse.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 micromouse.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.micromouse.xem4f, ) 
endif

clean,em4f::
	-$(RM) .tmp,micromouse.xem4f,0,*
...
clean,em4f::
	-$(RM) micromouse.xem4f
clean:: 
	-$(RM) package/cfg/micromouse_pem4f.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
micromouse_pem4f.oem4f,copy : package/cfg/micromouse_pem4f.oem4f
micromouse_pem4f.sem4f,copy : package/cfg/micromouse_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_micromouse
xconfig_micromouse.tar: package/package.bld.xml
xconfig_micromouse.tar: package/build.cfg
xconfig_micromouse.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_micromouse.tar.dep
endif
package/rel/xconfig_micromouse/xconfig_micromouse/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_micromouse.tar: package/rel/xconfig_micromouse.xdc.inc package/rel/xconfig_micromouse/xconfig_micromouse/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_micromouse.xdc.inc,package/rel/xconfig_micromouse.tar.dep)


release release,xconfig_micromouse: all xconfig_micromouse.tar
clean:: .clean
	-$(RM) xconfig_micromouse.tar
	-$(RM) package/rel/xconfig_micromouse.xdc.inc
	-$(RM) package/rel/xconfig_micromouse.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_micromouse.pjt
