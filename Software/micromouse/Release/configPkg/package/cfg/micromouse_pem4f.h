...
extern const ti_sysbios_knl_Clock_Handle control_loop_clk;

#include <ti/sysbios/knl/Task.h>
extern const ti_sysbios_knl_Task_Handle control_loop_tsk;

#include <ti/sysbios/knl/Task.h>
extern const ti_sysbios_knl_Task_Handle bt_rx_task;
